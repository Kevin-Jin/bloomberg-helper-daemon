...
@Singleton
@Produces("multipart/*")
public class PartialMultiPartWriter implements MessageBodyWriter<PartialMultiPart> {
    ...
    public PartialMultiPartWriter(@Context final Providers providers) {
        this.providers = providers;
    }

    @Override
    public long getSize(final PartialMultiPart entity,
                        final Class<?> type,
    ...
    @Override
    public void writeTo(final PartialMultiPart entity,
                        final Class<?> type,
                        final Type genericType,
                        final Annotation[] annotations,
                        final MediaType mediaType,
